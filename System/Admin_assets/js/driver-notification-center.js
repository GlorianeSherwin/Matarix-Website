...
(function() {
    ...
    function displayNotifications() {
        ...
        allNotifications.forEach(n => {
            ...
            html += `
                <div class="notification-item ${isUnread ? 'unread' : ''}" data-notification-id="${n.id}" data-order-id="${n.order_id || ''}" data-delivery-id="${n.delivery_id || ''}" style="cursor: pointer;">
    ...
    function attachHandlers() {
        ...
        document.querySelectorAll('.notification-item').forEach(item => {
            item.addEventListener('click', async (e) => {
                ...
                // Navigate to delivery details if delivery_id is available
                if (notif.delivery_id) {
                    window.location.href = `ViewDelivery.html?delivery_id=${notif.delivery_id}`;
                } else if (notif.order_id) {
                    window.location.href = `ViewDelivery.html?order_id=${notif.order_id}`;
                }
            });
        });
    }
