...
function generateCustomerMessage($activityType, $data = []) {
    $messages = [
        ...
        'proof_rejected' => "Your proof of payment for order #{$data['order_id']} has been rejected." . (isset($data['rejection_reason']) && !empty($data['rejection_reason']) ? " Reason: {$data['rejection_reason']}" : " Please upload a new proof of payment.")
    ];
