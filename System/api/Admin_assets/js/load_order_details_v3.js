...
async function loadOrderDetails() {
    ...
    if (viewReceiptLinkEarly) {
        ...
        viewReceiptLinkEarly.setAttribute('target', '_self');
        viewReceiptLinkEarly.addEventListener('click', function(e) {
            e.preventDefault();
            e.stopPropagation();
...
function displayOrderDetails(order) {
    ...
    if (viewReceiptLink) {
        ...
        if (isApproved) {
            ...
            viewReceiptLink.setAttribute('target', '_self');
            viewReceiptLink.replaceWith(viewReceiptLink.cloneNode(true));
            const linkAgain = document.querySelector('.view-receipt-link');
            if (linkAgain) {
                linkAgain.href = receiptUrl;
                linkAgain.setAttribute('href', receiptUrl);
            ...
            const viewReceiptLinkForStyle = document.querySelector('.view-receipt-link');
            if (viewReceiptLinkForStyle) {
                viewReceiptLinkForStyle.style.display = 'inline-block';
                viewReceiptLinkForStyle.style.visibility = 'visible';
                viewReceiptLinkForStyle.style.opacity = '1';
                viewReceiptLinkForStyle.style.pointerEvents = 'auto';
                viewReceiptLinkForStyle.style.cursor = 'pointer';
            }
            ...
            const linkToHide = document.querySelector('.view-receipt-link');
            if (linkToHide) linkToHide.style.display = 'none';
