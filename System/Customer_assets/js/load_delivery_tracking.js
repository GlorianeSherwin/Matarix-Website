            ...
            const initCalendarWithUnavailableDates = async () => {
                ...
                try {
                    ...
                    if (settingsData.success && settingsData.settings) {
                        ...
                        const rawMin = rawSettings.min_advance_notice_days ?? settingsData.settings.min_advance_notice_days;
                        const parsedMin = parseInt(rawMin, 10);
                        minAdvanceDays = (!isNaN(parsedMin) && parsedMin >= 0) ? parsedMin : 3;
                        const rawMax = rawSettings.max_advance_notice_days ?? settingsData.settings.max_advance_notice_days;
