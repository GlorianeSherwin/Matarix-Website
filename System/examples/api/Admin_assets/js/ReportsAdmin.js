...
$(document).ready(function() {
    ...
    // Ensure View Customer Feedbacks button is clickable (fallback for overlay/z-index issues)
    $('#customer-feedback-btn').on('click', function(e) {
        e.preventDefault();
    ...
    // Report period dropdown (1 day, 7 days, 30 days, 3 months)
    $('#report-period-select').on('change', function() {
        currentFilterDays = parseInt($(this).val(), 10) || 30;
        loadAnalytics();
        loadTopProducts();
    });
