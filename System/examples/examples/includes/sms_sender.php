...
class SMSSender {
     ...
     */
    public function sendProofReuploadRequestSMS($phoneNumber, $orderId) {
        $message = "Please reupload your proof of payment for order ORD-" . str_pad($orderId, 4, '0', STR_PAD_LEFT) . ". The current proof needs to be replaced. - MATARIK";
        return $this->sendSMS($phoneNumber, $message);
    }
}
